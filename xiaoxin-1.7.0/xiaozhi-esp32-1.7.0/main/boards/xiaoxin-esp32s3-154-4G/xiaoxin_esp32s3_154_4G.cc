...
#define TAG "XIAOXINESP32S31544G"
...
class XIAOXINESP32S31544G : public DualNetworkBoard {
private:
...
public:
    XIAOXINESP32S31544G() : boot_button_(BOOT_BUTTON_GPIO), volume_up_button_(VOLUME_UP_BUTTON_GPIO), volume_down_button_(VOLUME_DOWN_BUTTON_GPIO) {  
...
DECLARE_BOARD(XIAOXINESP32S31544G);
